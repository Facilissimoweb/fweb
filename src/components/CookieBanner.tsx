    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-6 left-6 right-6 md:left-auto md:right-6 md:w-[420px] bg-white/75 dark:bg-[#04045E]/75 backdrop-blur-lg border-2 border-[#B9FA3C] rounded-[28px] p-6 shadow-[0_0_30px_rgba(185,250,60,0.25)] z-[90] text-on-surface"
        >
