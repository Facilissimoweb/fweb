      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 md:inset-auto md:bottom-[88px] md:right-6 md:w-[410px] md:h-[580px] md:max-h-[calc(100vh-170px)] bg-white/75 dark:bg-[#04045E]/75 backdrop-blur-lg border-2 border-[#B9FA3C] rounded-none md:rounded-[32px] shadow-[0_0_30px_rgba(185,250,60,0.25)] z-[120] flex flex-col overflow-hidden text-on-surface"
          >
            {/* Header */}
