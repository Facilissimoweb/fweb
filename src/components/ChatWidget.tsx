      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[88px] right-4 left-4 md:left-auto md:right-6 md:w-[410px] h-[580px] max-h-[calc(100vh-120px)] bg-white border border-outline-variant/30 rounded-[32px] shadow-2xl z-[95] flex flex-col overflow-hidden text-on-surface"
          >
            {/* Header */}
