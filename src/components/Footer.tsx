...
export default function Footer({ onOpenPrivacy, onOpenCookie, onOpenSitemap }: FooterProps) {
  ...
  return (
    <footer className="bg-surface-container-low dark:bg-surface-dim border-t border-outline-variant/10 flex flex-col items-center gap-6 py-12 px-6 text-center mt-20">
      {/* Small Logo */}
      <div
