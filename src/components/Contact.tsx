      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        >
          <form
            ...
            className="space-y-8 bg-white/75 dark:bg-[#1C122C]/75 backdrop-blur-lg p-8 md:p-10 rounded-[40px] shadow-[0_0_30px_-5px_rgba(221,242,71,0.25)] border-4 border-[#DDF247]"
            id="contact-form"
          >
            {/* Nome Field */}
